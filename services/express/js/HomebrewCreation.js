...
module.exports = class HomebrewCreation {
  static addTrait(homebrewID, data) {
    ...
    if (data.traitName == null) {
      data.traitName = "Unnamed Trait";
    }
    data.traitName = data.traitName.replace(/’/g, "'");
    if (data.traitDescription == null) {
      data.traitDescription = "__No Description__";
    }
    return Tag.create({
      // Create Trait
  ...
  static deleteTrait(homebrewID, traitID) {
    if (traitID == null || homebrewID == null) {
      return;
    }
    return Tag.destroy({
      // Delete Trait
  ...
  static addToggleable(homebrewID, data) {
    ...
    if (data.toggleableName == null) {
      data.toggleableName = "Unnamed Toggleable";
    }
    data.toggleableName = data.toggleableName.replace(/’/g, "'");
    if (data.toggleableDescription == null) {
      data.toggleableDescription = "__No Description__";
    }
  ...
  static deleteToggleable(homebrewID, toggleableID) {
    if (toggleableID == null || homebrewID == null) {
      return;
    }
    return SheetState.destroy({
      // Delete Toggleable
  ...
  static deleteCreature(homebrewID, creatureID) {
    if (creatureID == null || homebrewID == null) {
      return;
    }
  ...
  static addLanguage(homebrewID, data) {
    ...
    if (data.languageName == null) {
      data.languageName = "Unnamed Language";
    }
    data.languageName = data.languageName.replace(/’/g, "'");
    if (data.languageDescription == null) {
      data.languageDescription = "__No Description__";
    }
  ...
  static deleteLanguage(homebrewID, languageID) {
    if (languageID == null || homebrewID == null) {
      return;
    }
  ...
  static addBackground(homebrewID, data) {
    ...
    if (data.backgroundName == null) {
      data.backgroundName = "Unnamed Background";
    }
  ...
  static deleteBackground(homebrewID, backgroundID) {
    if (backgroundID == null || homebrewID == null) {
      return;
    }
      ...
      return Class.create({
        ...
        if (data.classFeatsArray != null) {
          for (const classFeat of data.classFeatsArray) {
            ...
            let newPromise = HomebrewCreation.addFeatPreparedData(
              homebrewID,
              classFeat,
            );
        ...
        return Promise.all(classFeatPromises).then(function (result) {
          ...
          if (data.classAbilitiesArray != null) {
            for (const classAbility of data.classAbilitiesArray) {
              ...
              let newPromise = HomebrewCreation.addClassAbility(
                homebrewID,
                cClass.id,
                classAbility,
              );
  ...
  static deleteClass(homebrewID, classID) {
    if (classID == null || homebrewID == null) {
      return;
    }
    return Class.findOne({
      where: { id: classID, homebrewID: homebrewID },
    }).then((cClass) => {
      if (cClass == null) {
        return;
      }
      return FeatTag.findAll({ where: { tagID: cClass.tagID } }).then(
        (featTags) => {
          ...
          return Promise.all(classFeatsPromises).then(function (result) {
            return Tag.destroy({
  ...
  static addClassFeature(homebrewID, data) {
    ...
    if (data.classFeatureData.indivClassAbilName == null) {
      return HomebrewCreation.addClassAbility(
        homebrewID,
        null,
      ...
      return HomebrewCreation.addClassAbilityOption(
        homebrewID,
        data.classFeatureData,
      ).then((classAbility) => {
        return classAbility;
  ...
  static deleteClassFeature(homebrewID, classFeatureID) {
    if (classFeatureID == null || homebrewID == null) {
      return;
    }
  ...
  static addArchetype(homebrewID, data) {
    ...
    if (data.archetypeName == null) {
      data.archetypeName = "Unnamed Archetype";
    }
  ...
  static deleteArchetype(homebrewID, archetypeID) {
    if (archetypeID == null || homebrewID == null) {
      return;
    }
    return Archetype.findOne({
      where: { id: archetypeID, homebrewID: homebrewID },
    }).then((archetype) => {
      if (archetype == null) {
        return;
      }
  ...
  static addAncestry(homebrewID, data) {
    ...
    if (data.ancestryName == null) {
      data.ancestryName = "Unnamed Ancestry";
    }
            ...
            return Promise.all(ancestryLangsPromises).then(function (result) {
              ...
              if (data.ancestryHeritagesArray != null) {
                for (const ancestryHeritage of data.ancestryHeritagesArray) {
                  ...
                  let newPromise = HomebrewCreation.addHeritage(
                    homebrewID,
                    ancestry.id,
                    ancestryHeritage,
                  );
  ...
  static deleteAncestry(homebrewID, ancestryID) {
    if (ancestryID == null || homebrewID == null) {
      return;
    }
    return Ancestry.findOne({
      where: { id: ancestryID, homebrewID: homebrewID },
    }).then((ancestry) => {
      if (ancestry == null) {
        return;
      }
  ...
  static deleteHeritage(homebrewID, heritageID) {
    if (heritageID == null || homebrewID == null) {
      return;
    }
    return Heritage.destroy({
  ...
  static addUniHeritage(homebrewID, data) {
    ...
    if (data.heritageName == null) {
      data.heritageName = "Unnamed Versatile Heritage";
    }
  ...
  static deleteUniHeritage(homebrewID, uniHeritageID) {
    if (uniHeritageID == null || homebrewID == null) {
      return;
    }
    return UniHeritage.findOne({
      where: { id: uniHeritageID, homebrewID: homebrewID },
    }).then((uniHeritage) => {
      if (uniHeritage == null) {
        return;
      }
      return FeatTag.findAll({ where: { tagID: uniHeritage.tagID } }).then(
        (featTags) => {
  ...
  static deleteFeat(homebrewID, featID) {
    if (featID == null || homebrewID == null) {
      return;
    }
    return Feat.destroy({
  ...
  static deleteItem(homebrewID, itemID) {
    if (itemID == null || homebrewID == null) {
      return;
    }
    return Item.destroy({
  ...
  static deleteSpell(homebrewID, spellID) {
    if (spellID == null || homebrewID == null) {
      return;
    }
