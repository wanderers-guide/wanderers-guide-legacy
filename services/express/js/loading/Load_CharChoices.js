...
module.exports = async function (
  ...
  if (ancestries == null) {
    ancestries = CharGathering.getAllAncestriesBasic(
      userID,
  ...
  if (classDetails == null) {
    classDetails = CharGathering.getClass(
      userID,
      charID,
      character.classID,
      character.enabledSources,
  ...
  if (phyFeatDataArray == null) {
    phyFeatDataArray = CharDataMapping.getDataAll(
      charID,
      "phyFeats",
      PhysicalFeature,
    );
  ...
  if (domains == null) {
    domains = CharGathering.getAllDomains(
      userID,
      character.enabledSources,
      character.enabledHomebrew,
    );
  ...
  if (advancedDomainDataArray == null) {
    advancedDomainDataArray = CharDataMapping.getDataAll(
      charID,
      "advancedDomains",
      Domain,
    );
  ...
  if (extraClassFeatures == null) {
    extraClassFeaturesArray = CharGathering.getAllExtraClassFeatures(
      userID,
      charID,
    );
  }
  ...
  if (heritageEffectsArray == null) {
    heritageEffectsArray = CharDataMapping.getDataAll(
      charID,
      "heritageExtra",
      Heritage,
    );
  ...
  let promise = await Promise.all([
    ...
    senseDataArray,
    phyFeatDataArray,
    innateSpellDataArray,
    profMap,
    domains,
    ancestries,
    domainDataArray,
    advancedDomainDataArray,
    scfsDataArray,
    focusPointDataArray,
    loreDataArray,
    extraClassFeaturesArray,
    heritageEffectsArray,
    classArchetypeID,
  ]);
