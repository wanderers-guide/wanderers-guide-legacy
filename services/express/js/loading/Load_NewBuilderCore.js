...
module.exports = async function (userID, charID = null, buildID = null) {
  ...
  let sourceBooks;
  if (charID == null) {
    sourceBooks = await CharGathering.getSourceBooks(
      userID,
      build.enabledSources,
  ...
  let featsObject;
  if (charID == null) {
    featsObject = CharGathering.getAllFeats(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
      (feats = null),
  ...
  let itemMap;
  if (charID == null) {
    itemMap = CharGathering.getAllItems(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
      (items = null),
  ...
  let spellMap;
  if (charID == null) {
    spellMap = CharGathering.getAllSpells(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
      (spells = null),
  ...
  let allLanguages;
  if (charID == null) {
    allLanguages = CharGathering.getAllLanguagesBasic(
      userID,
      build.enabledHomebrew,
    );
  } else {
  ...
  let classes;
  if (charID == null) {
    classes = CharGathering.getAllClasses(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
    );
  ...
  let ancestries;
  if (charID == null) {
    ancestries = CharGathering.getAllAncestries(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
      true,
  ...
  let backgrounds;
  if (charID == null) {
    backgrounds = CharGathering.getAllBackgrounds(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
    );
  ...
  let archetypes;
  if (charID == null) {
    archetypes = CharGathering.getAllArchetypes(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
    );
  ...
  let uniHeritages;
  if (charID == null) {
    uniHeritages = CharGathering.getAllUniHeritages(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
    );
  ...
  let allDomains;
  if (charID == null) {
    allDomains = CharGathering.getAllDomains(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
    );
  ...
  let classArchetypes;
  if (charID == null) {
    classArchetypes = CharGathering.getAllClassArchetypes(
      userID,
      build.enabledSources,
      build.enabledHomebrew,
    );
  ...
  if (charID == null) {
    ...
    return BuildsGathering.getAllMetadata(buildID).then((buildMetaData) => {
      const choiceStruct = {
        character: build,
    ...
    return CharGathering.getAllMetadata(userID, charID).then((charMetaData) => {
      const choiceStruct = {
        character,
        charMetaData,
      };
