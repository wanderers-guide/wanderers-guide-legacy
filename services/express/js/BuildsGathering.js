            ...
            return CharGathering.getClass(
              ...
              return Heritage.findOne({
                ...
                return UniHeritage.findOne({
                  ...
                  // Source Material
                  return GeneralGathering.getAllSkills(userID).then(
                    (skillObject) => {
                        ...
                        return CharGathering.getAllFeats(
                          ...
                          return CharGathering.getAllItems(
                            ...
                            return CharGathering.getAllSpells(
                              ...
                              return CharGathering.getAllLanguagesBasic(
                                userID,
                                build.enabledHomebrew,
                              ).then((allLanguages) => {
                                return CharGathering.getAllConditions(
                                  userID,
                                ).then((allConditions) => {
                                  // User Collected Bundles
                                  return UserHomebrew.getCollectedHomebrewBundles(
                                    userID,
                                  ).then((hBundlesCollected) => {
                                    return UserHomebrew.getIncompleteHomebrewBundles(
                                      userID,
                                    ).then((hBundlesProgess) => {
                                      return {
                                        buildData,
                                        build,
                                        mainSelections: {
