...
function openWarningsQuickview(data) {
  ...
  $('#quickViewTitleRight').html('<button id="clearWarningsBtn" class="button is-very-small is-danger is-outlined is-rounded is-pulled-right mr-1">Clear Warnings</button>');
  $('#clearWarningsBtn').click(function () {
    socket.emit("requestUnselectedDataClear", getCharIDFromURL());
