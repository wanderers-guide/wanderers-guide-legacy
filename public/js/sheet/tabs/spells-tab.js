  ...
  for(let slot of slotArray){
      ...
      if(spellDataStruct != null) {
          ...
          switch(spellDataStruct.Spell.cast) {
              ...
              case 'TWO_ROUNDS': castActions = '<span>2 rounds</span>'; break;
              case 'THREE_ROUNDS': castActions = '<span>3 rounds</span>'; break;
              ...
              case 'THIRTY_MINUTES': castActions = '<span>30 minutes</span>'; break;
