...
router.get("/", (req, res) => {
  let editHomebrewID = parseInt(req.query.edit_id);
  if (isNaN(editHomebrewID)) {
    editHomebrewID = null;
  }
  let viewHomebrewID = parseInt(req.query.view_id);
  if (isNaN(viewHomebrewID)) {
    viewHomebrewID = null;
  }
...
router.get("/edit/class", bundleAuthCheck, (req, res) => {
  ...
  let classID = parseInt(req.query.content_id);
  if (isNaN(classID)) {
    classID = null;
  }
...
router.get("/edit/ancestry", bundleAuthCheck, (req, res) => {
  ...
  let ancestryID = parseInt(req.query.content_id);
  if (isNaN(ancestryID)) {
    ancestryID = null;
  }
...
router.get("/edit/archetype", bundleAuthCheck, (req, res) => {
  ...
  let archetypeID = parseInt(req.query.content_id);
...
router.get("/edit/background", bundleAuthCheck, (req, res) => {
  ...
  let backgroundID = parseInt(req.query.content_id);
...
router.get("/edit/class-feature", bundleAuthCheck, (req, res) => {
  ...
  let classFeatureID = parseInt(req.query.content_id);
  if (isNaN(classFeatureID)) {
    classFeatureID = null;
  }
...
router.get("/edit/feat-activity", bundleAuthCheck, (req, res) => {
  ...
  let featID = parseInt(req.query.content_id);
  if (isNaN(featID)) {
    featID = null;
  }
...
router.get("/edit/heritage", bundleAuthCheck, (req, res) => {
  ...
  let heritageID = parseInt(req.query.content_id);
  if (isNaN(heritageID)) {
    heritageID = null;
  }
...
router.get("/edit/uni-heritage", bundleAuthCheck, (req, res) => {
  ...
  let uniHeritageID = parseInt(req.query.content_id);
  if (isNaN(uniHeritageID)) {
    uniHeritageID = null;
  }
...
router.get("/edit/item", bundleAuthCheck, (req, res) => {
  ...
  let itemID = parseInt(req.query.content_id);
  if (isNaN(itemID)) {
    itemID = null;
  }
...
router.get("/edit/spell", bundleAuthCheck, (req, res) => {
  ...
  let spellID = parseInt(req.query.content_id);
  if (isNaN(spellID)) {
    spellID = null;
  }
...
router.get("/edit/language", bundleAuthCheck, (req, res) => {
  ...
  let languageID = parseInt(req.query.content_id);
  if (isNaN(languageID)) {
    languageID = null;
  }
...
router.get("/edit/trait", bundleAuthCheck, (req, res) => {
  ...
  let traitID = parseInt(req.query.content_id);
  if (isNaN(traitID)) {
    traitID = null;
  }
...
router.get("/edit/toggleable", bundleAuthCheck, (req, res) => {
  ...
  let toggleableID = parseInt(req.query.content_id);
  if (isNaN(toggleableID)) {
    toggleableID = null;
  }
...
router.get("/edit/creature", bundleAuthCheck, (req, res) => {
  ...
  let creatureID = parseInt(req.query.content_id);
  if (isNaN(creatureID)) {
    creatureID = null;
  }
